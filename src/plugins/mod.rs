...
use crate::{
    assets::{bundles::BundlesAssetLoader, resource::ResourceAssetLoader},
    BundlesAsset, ResourceAsset,
};
use bevy::prelude::*;
...
impl Plugin for FluentPlugin {
    fn build(&self, app: &mut App) {
        app.register_asset_loader(ResourceAssetLoader)
            ...
            .register_asset_loader(BundlesAssetLoader)
            .init_asset::<BundlesAsset>();
    }
}
